...
('agent',	10000,	'Client Agents',	1,	'^.*$',	'Custom user group for users acting on behalf of a company client. They may or may not be operating via a third party agency organisation (eg. a lottery provider).'),
